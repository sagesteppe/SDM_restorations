...
% Species Cover on plot = sum(aggregate suitable cells)
% Species Cover on plot = sqrt(sum(aggregate suitable cells))
% Species Cover on plot = log(sum(aggregate suitable cells))
