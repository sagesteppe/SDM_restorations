...
filter(thinned, str_detect(taxon, '^T')) |> 
  pull(taxon) |> 
  unique() 
...
```{r}
pts1 <- filter(thinned, taxon == 'Syntrichopappus fremontii')
...
OUTPUT <- filter(OUTPUT, !ID %in% c(296, 167, 286))
...
# Lomatium dissectum c(1429, 1831, 819:821, 1143, 2084)
...
# Mentzelia multiflora c(574, 725)
