...
p <- '/media/steppe/hdd/Geospatial_data/WesternPlantPredictors2/chelsa/bio4'
...
filter(thinned, str_detect(taxon, '^P')) |> 
  pull(taxon) |> 
  unique() 
...
```{r}
pts1 <- filter(thinned, taxon == 'Penstemon eatonii')
...
OUTPUT <- filter(OUTPUT, !ID %in% c(360, 213, 1, 507, 765, 618, 337, 851, 576, 815, 193, 465, 525, 169, 394:396, 464, 413, 740, 614, 849, 748, 654, 663, 735, 811, 754, 223, 538, 3, 470, 544, 784, 541, 484))
...
OUTPUT <- filter(OUTPUT, !ID %in% c(360, 213, 1, 507, 765, 618, 337, 851, 576, 815, 193, 465, 525, 169, 394:396, 464, 413, 740, 614, 849, 748, 654, 663, 735, 811, 754, 223, 538, 3, 470, 544, 784, 541, 484, 623, 243, 142, 824, 201, 212, 206, 640, 419, 474, 348, 434, 375, 569, 218, 244, 596, 648, 323, 546, 53, 54, 492, 482, 446, 761, ))
