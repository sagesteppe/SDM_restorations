...
filter(thinned) |> 
  pull(taxon) |> 
  unique() |>
  write.table('species.txt', row.names = FALSE)

rm(bio1, bio10, bio12, bio4, bio19, p, files)
```

```{r}
pts1 <- filter(thinned, taxon == 'Lomatium macrocarpum')
...
OUTPUT <- filter(OUTPUT, !ID %in% c(1719, 2643, 2651, 249, 2488, 2424, 2499))

leaflet(data = filter(OUTPUT, ID > 0)) %>%  addTiles() %>%
...
# Leymus triticoides c(327)
# Lomatium dissectum c(933, 880, 1075, 1118, 931, 204)
# Lomatium grayi c(137, 765, 212, 244, 740, 586, 320, 321, 359, 148,312)
# Lomatium macrocarpum c(1429, 1831, 819:821, 1143, 2084)
# Lomatium nevadense c(537, 435, 491, 254, 420)
# Lomatium nevadense var. nevadense c(153, 171, 28, 159, 14)
# Lomatium nudiacaule c(1006, 737, 1067, 154, 723, 886, 841) 
# Lomatium parryi c(57, 161)
# Lomatium triternatum c(1825, 2225, 2362, 935, 1945, 1875)
# Lupinus arboreus c(1:22, 987, 1178, 1047, 1227, 471, 1101, 122, 1069, 960, 1060, 1170, 1045, 437, 122, 1160, 1124, 587, 1026, 1020, 1094, 213, 1117, 943, 1004, 1164, 1087, 1000, 537, 1068)
# Lupinus argenteus c(4046, 4961, 736, 4712, 4733, 4678, 2773, 4865, 1894, 4368, 4099, 3864, 3941, 4357, 5874, 2773, 4566, 4866, 4790, 4805, 4821, 4743, 5010, 4723, 4710, 4336, 4874)
# Lupinus arizonicus c(1333, 29, 4:7, 439, 14:16, 870, 896, 1309)
# Lupinus bicolor c(25:27, 1, 2, 4:5, 3020, 2926, 1313, 1701, 1926, 2671, 2801, 1925, 1673)
# Lupinus flavoculatus c(7, 47)
# Lupinus odoratus  c(85, 9, 118, 131, 83, 40))
# Lycium andersonii c(576, 1311, 1576)
# Lycium cooperi c(115, 220, 219, 519, 7, 301, 422, 494, 387, 309, 66 )
# Lycium pallidum c(743, 709, 771, 334, 63, 176, 336)
# Macheranthera canescens c(2424)


# Madia elegans (5, 8, 891, 301, 975, 909, 953, 1186))
# Madia gracilis # no errors
# Malacothrix glabrata c(1593, 1878, 1224, 1854, 66, 67, 1723, 2266)
# Malvella leprosa # no errors
# Menodora spinescens c(158, 261, 46, 153, 147)
# Mentha canadensis # no errors
# Mentzelia affinis c(67, 332, 258, 53, 33, 226, 139)
# Mentzelia albicaulis c(3629, 3406, 1593, 2207, 3293, 3501, 3268, 2370)
# Mentzelia laevicaulis c(402, 146, 328, 909, 883, 637, 951)
# Mentzelia multiflora c(402, 146, 328, 909, 883, 637, 951)
# Mirabilis laevis c(1760, 123, 1619, 1788, 93)
# Mirabilis lanata (PROBLEM)
# Muhlenbergia porteri c(1247, 1458)
# Muhlenbergia rigens c(615, 285, 634, 829)
# Nassela pulchra c(1, 689, 523)
# Nicotiana attenuata c(159, 706, 870, 202, 531, 492, 394, 46, 131)
# Nicotiana obtusifolia # NO ERRORS
# Oenothera cespitosa c(699, 522)
# Oenothera deltoides c(80, 51, 42, 558, 552)
# Oenothera primiveris c(2, 28, 29, 511, 236, 331, 133, 236, 482)
# Olneya tesota c(1333, 150, 151, 154:156, 490, 488, 1251, 1307, 157)
# Opuntia basilaris c(2513, 1749, 373, 345, 344, 360:363, 291)
# Oxystylis lutea # no errors
# Packera multilobata c(531, 817:818, 1893, 1899, 1960, 2201, 532)
# Parkinsonia florida c(1042, 1008, 936, 901, 721, 907, 791, 282)
# Pectis papposa c(26:31, 668, 306, 231, 1053, 118, 25, 186, 1112, 279)
# Penstemon acuminatus c(15, 160, 78, 212, 168) # too few records in nevada?
# Penstemon deustus c(680, 836, 251, 228, 321, 661)
# Penstemon eatonii c(360, 213, 1, 507, 765, 618, 337, 851, 576, 815, 193, 465, 525, 169, 394:396, 464, 413, 740, 614, 849, 748, 654, 663, 735, 811, 754, 223, 538, 3, 470, 544, 784, 541, 484, 623, 243, 142, 824, 201, 212, 206, 640, 419, 474, 348, 434, 375, 569, 218, 244, 596, 648, 323, 546, 53, 54, 492, 482, 446, 761, 442, 574, 351, 242, 5376, 415, 167, 417, 382, 688, 423, 215, 389, 528, 732)
# Penstemon incertus c(105, 87, 101)
# Penstmon pachyphyllus c(136:137, 174, 249, 362)
# Penstemon palmeri # GO BACK
# Penstemon speciosus c(1679:1201, 1715, 1012, 1084, 193, 1004, 1109, 1727)
# Perideridia bolanderi c(205, 334, 320, 426, 372)
# Peritoma arborea c(86, 132, 99)
# Persicaria amphibia # no errors
# Persicaria lapathifolia # no errors
# Peucephyllum schottii c(410, 584, 591, 220, 841, 775)
# Phacelia crenulata c(1765, 1433, 440, 1773, 2039, 346, 2029)
# Phacelia distans c(4:5, 78, 3366)
# Phacelia fremontii c(31, 115:118, 696)
# Phacelia hastata c(1247)
# Phacelia heterophylla c(70:71, 206, 337, 387, 483, 207, 705, 721, 1146, 574, 386, 543, 792, 56:59, 792, 940, 932, 566:571, 696:697, 261:262, 130:131, 1315, 1865, 713:714, 81, 64:65, 464:466)
# Phacelia humilis c(69, 125, 186, 4, 180)
# Phacelia linearis c(1130, 910, 1302, 1385, 1615, 1574, 1248, 438)
# Phlox stansburyi c(350, 299, 407, 271, 132, 341, 286:288, 414, 327, 138:139, 274:276, 289, 278)
# Phyla nodiflora  c(539, 1, 651, 408)
# Pickeringia montana c(221)
# Picrothamnus desertorum c(93, 647, 1472)
# Plantago erecta c(1651, 1, 1825, 1255, 1683, 1244, 1526, 1065, 1809, 1345, 1356, 1021, 1563, 1256, 877)
# Plantago ovata c(1533, 1941, 809, 493, 1614, 1955, 1081 )
# Platanus racemosa c(192, 1135, 918, 947, 1507, 442 )
# Pleiacanthus spinosus c(603, 928, 820, 951)
# Pleuraphis jamesii c(3659, 1717, 1742, 1725, 3712)
# Prosopis glandulosa c(709, 726, 2368, 1408, 1792, 1472, 907, 2106, 2136, 718)
# Psathyrotes ramosissima c(64, 278, 125, 231, 240)
# Pseudoroegneria spicata # no errors
# Psorothamnus fremontii c(348, 455)
# Psorothamnus schottii c(607)
# Psorothamnus spinosus c(4:6, 8:11, 21:22, 17, 24, 1)
# Purshia glandulosa c(174, 198, 259, 24, 231, 242, 260, 92, 41, 324, 18:21)
# Ranunculus californicus c(136, 1064, 1400, 629, 1207, 1166, 1387, 1228, 1390, 1227, 1239, 1484, 3, 708, 594, 256, 650, 554, 1456, 533, 1060, 552, 1371, 1101, 1297)
# Rhamnus californica c(102)
# Rosa californica c(11,1368, 1204, 1333, 932, 1191, 200, 745, 358, 912, 1200, 1285, 12, 903, 553, 13, 1032, 775, 1228)
# Rubus ursinus c(70, 90, 3388)
# Rumex salicifolius # no errors
# Sagittaria latifolia # no errors
# Salazaria mexicana c(329, 700)
# Salvia columbariae c(4047, 3182, 941, 2611, 2863, 4244, 2685, 3648, 3591, 2988)
# Sambucus mexicana # NO ERRORS - BUT REVIEW TAXONOMY
# Senecio integerrimus c(1442, 2630, 2509, 2397)
# Senecio spartioides c(388, 674, 445)
# Senegalia greggii c(1517, 930, 1486, 1413, 477, 655)
# Senna armata c(247)
# Sisyrnchium bellum c(4418, 1587, 1271, 3864, 4123, 4204)
# Solanum americanum c(302, 238, 796, 657)
# Solidago velutina c(101:105, 38, 67, 72, 637, 107:108)
# Sphaeralcea ambigua c(3332, 2914, 2903, 1813, 2755, 2118, 2919, 2774, 1060, 701, 1116, 2863, 590, 750, 1632, 1049, 702, 3070, 3072, 1050, 1067, 2698, 1117, 1055, 579, 699, 1056, 1122, 1059, 1061, 3224, 3013, 2625, 1975, 2518, 2789, 3281, 1120, 700, 1709, 2615, 1123, 2561, 2759, 2360, 2694, 2927, 3106, 2971, 2778, 2709, 2424, 2535, 2167, 2252, 2660, 2230, 2720, 2271, 2631, 3016, 2228, 2194, 2228, 2194, 2559, 3426, 3502, 2466, 2663,2721, 2146, 2336, 2297, 2422, 2788, 2327, 3144, 2370, 2508, 2597, 2593, 2299, 2873, 2458, 2617, 3464, 2165, 3444, 3169, 3578, 1977, 1701, 1879, 1509, 1621, 1928, 1859, 1770, 1543, 1933, 1691, 1545, 1754, 1684, 1880, 1023, 1025, 1246, 420:422, 870, 1456, 1031, 1475, 1453, 1035, 441, 440, 1032, 1346, 424, 329:332, 1022, 1036, 624, 1455, 658, 1255, 1275, 1385, 1037, 476, 222, 1458, 1470, 333, 221, 793, 610, 32, 368, 599, 1228, 598, 1196, 604, 1212, 600, 910:917, 35:45, 1198, 749, 1210:1215, 602, 1195, 369:371, 367, 1174, 686, 1722, 1634)
# Sphaeralcea coccinea c(6838, 4563, 4155, 4151, 327, 325, 1972, 4577, 4728, 4153:4155, 2, 3243, 252, 6189, 323:326, 733, 6748, 4436, 4441, 251:255, 6846, 6229, 6304, 6946, 3683, 4470, 6961, 6904, 6510, 7016, 6788, 4472)
# Sphaeralcea grossulariifolia c(14:17, 4, 22:23, 242, 38, 43:47, 515, 326)
# Sphaeralcea munroana c(627, 157, 754, 510, 597, 537, 661, 790, 453, 599, 486)
# Sporobolus airoides c(2350, 1414, 1799)
# Sporobolus cryptandrus c(2557, 2919, 3133, 3453, 3419, 2760, 3871, 3877, 3597, 2320, 3783, 3966, 3920, 3929, 3783, 3174)
# Stanleya pinnata c(1022, 849)
# Stenotus acualis c(2602, 2673, 2516, 1779, 2585, 2273, 344, 1170)
# Stephanomeria exigua c(164, 774, 1033)
# Stephanomeria parryi c(110, 63, 144, 26, 55)
# Stephanomeria pauciflora c(130, 1560, 1274, 1463, 2028, 900, 1296)
# Symphyotrichum subulatum # no errors
# Syntrichopappus fremontii c(296, 167, 286)
#  'Thelesperma megapotamicum'  c(581, 245, 1202, 1106, 677, 1059, 1258, 404, 108, 157)
# Triteleia hyacinthina c(56, 484, 1199, 1088)
# Triteleia laxa c(2016)
# Vulpia microstachys c(579, 254, 253, 790, 697)
# Vulpia octoflora # no errors
# Wyethia angustifolia c(1, 555, 740)
# Xylorhiza tortifolia c(763, 789)
# Yucca brevifolia c(2373, 3219)
# Yucca jaegeriana c(40, 56, 61)
# Yucca schidigera c(1719, 2643, 2651, 249, 2488, 2424, 2499)
```
