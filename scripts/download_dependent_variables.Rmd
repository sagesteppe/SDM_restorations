...
write.csv(idig, '../data/raw/occurrence/IDIG2.csv')
```
...
target_symbols <- c('ADFA', 'ADFAF', 'ADFAO', 'BREL', 'BRELE', 'KRGR', 'LOHU2')
targets <- filter(targets, symbol %in% target_symbols) %>% 
  distinct()
...
st_write(spp_richness, '../data/raw/occurrence/AIM/AIM_records2.shp', append = F)
