...
write.csv(thinned, '../data/raw/occurrence/thinned_occurrences.csv', row.names = F)
...
write.csv(repeated_occurrences, '../data/raw/occurrence/repeated_occurrences.csv', row.names = F)
