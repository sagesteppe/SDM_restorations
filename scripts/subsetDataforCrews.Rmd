...
a <- lapply(X = spp_needed_test[1], FUN = empiricalSTZ_writer, seed_zones = seed_zones, pSTZs = ptest)

b <- vect(spp_needed_test[[1]][,'path_basins'])

ob <- terra::mask(b, ptest)

plot(a[["Aristida_purpurea"]])
```
