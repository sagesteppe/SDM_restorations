...
focal_bbox <- dplyr::filter(admin_boundaries, ADMU_NA %in% stringr::str_to_upper(teams_list[[13]]$FieldOffice) ) %>%  
  sf::st_union() %>% 
...
lapply(X = spp_needed_test[1], FUN = empiricalSTZ_writer, 
            seed_zones = seed_zones, pSTZs = ptest) # 24 pts, 245 polys
