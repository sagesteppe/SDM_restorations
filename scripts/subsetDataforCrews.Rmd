...
focal_area <- dplyr::filter(admin_boundaries, ADMU_NA == str_to_upper('St. George Field Office' )) |>
  sf::st_union() |>
  sf::st_transform(5070) |>
  vect()

focal_r <- rast(file.path(path, f[[1]]))
