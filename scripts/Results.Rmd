...
ggplot(suitability_amounts,
  ...
  geom_line(data = suitability_means, aes(y = Percent/100, x = Null_mod),
            color = '#d95f02', inherit.aes = F,  lwd = 1, lty = 53, linemitre = 2) +
  geom_line(data = fp, aes(y = suitability, x = obs*100),
            color = '#7570b3', inherit.aes = F,  lwd = 1, lty = 53) +
  ...
  geom_label(data = labs, aes(x = x, y = y, label = label), inherit.aes = F, size = 2.5)
