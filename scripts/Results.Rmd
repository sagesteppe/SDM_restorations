...
ggplot(suitability_amounts, aes(x = Percent, y = Records, color = Species, group = Species)) +
  geom_line(lty = 1) +
  ...
  geom_line(data = suitability_means, 
            aes(x = Percent, y =  mean, color = 'a'), color = '#093824', inherit.aes = F, lwd = 1) + 
  geom_line(data = fp, aes(x = suitability*100, y = obs), color = '#FF2C55', inherit.aes = F,  lwd = 1) 
  ...
  scale_x_continuous(breaks = seq(0, 100, by = 20), labels = \(x) paste0(x, "%")) + 
  theme(
