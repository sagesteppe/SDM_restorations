...
lapply(models_occ[3], predict_wrapper)

r <- terra::rast('../results/suitability_maps/Acamptopappus_sphaerocephalus.tif')
plot(r)
...
g <- readRDS('../results/rf_models/Abronia_villosa-2023-12-30_14:48:33.rds')
