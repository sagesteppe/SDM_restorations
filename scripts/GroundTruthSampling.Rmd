...
lyr1 <- as.numeric(quantile(samples$SumOccupiedPatches, probs = 0.75))
lyr2 <- as.numeric(quantile(samples$Sum1stOrderNeighboringPatches, probs = 0.75))
lyr3 <- as.numeric(quantile(samples$CommonessInversion, probs = 0.75))
