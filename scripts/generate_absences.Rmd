...
st_write(out, '../data/raw/occurrence/absences/absences1km.shp', append = FALSE)
...
lapply(splicies[41:335], lda_PA_dropper, path = '../results/lda2/', col_names = cn)

which(names(splicies) == 'Asclepias speciosa')
